...
/*************************************************************************************************************************
 *
 * @brief      This case, CLK error signal can trigger TZ.
 *
 *
 *************************************************************************************************************************/
...
int main(void)
{
    ...
    /* Enable CLK error interrupt */
    eErrorState = EPWR_WriteRegister(HV_REG_TZIE1, TZIE1_RCOERR_ENABLE | TZIE1_LPRCOERR_ENABLE);
    if (eErrorState == ERROR)
    {
