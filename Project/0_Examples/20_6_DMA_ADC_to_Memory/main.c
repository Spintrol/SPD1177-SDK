...
int32_t             *pi32Result                  = (int32_t *)RESULT_ADDRESS;
...
/*************************************************************************************************************************
 *
 * @brief       This example use DMA channel 0 to transfer the data from ADC to RAM.
 *
 *
 *
 *************************************************************************************************************************/
...
void DMAC_IRQHandler(void)
{
    ...
    if (DMA_GetTransferCompleteIntFlag(DMA_CH0) != 0)
    {
        ...
        printf("The voltage is %2.1f\n", (double)ValueToVoltage(*((int32_t *)pi32Result)));
