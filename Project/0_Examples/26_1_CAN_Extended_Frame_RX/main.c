 ...
 *             "CAN_Standard_And_Extended_Frame_TX" "CAN_Standard_Frame_RX".
 ...
 * 
 * @TestResult :   Serial display "Receives CAN Extended Remote frame success" 
 *                 "Receives CAN Extended Data frame success"
