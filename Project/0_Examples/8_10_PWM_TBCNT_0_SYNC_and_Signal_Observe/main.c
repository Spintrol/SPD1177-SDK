...
uint32_t            u32ActualReLoadVal1;
uint32_t            u32ActualReLoadVal2;


/*************************************************************************************************************************
 *
 * @brief      In this case, PWM0 will output SYNC signal on the point 'TBCNT=zero' continuously, the SYNC signal reach the
 *             PWM1 and then pass to the PWM2.
 *
 *
 *************************************************************************************************************************/
...
int main(void)
{
    ...
    */
    ...
    PWM_SetSyncReloadValue(PWM1, u32ActualReLoadVal1);
    PWM_SetSyncReloadValue(PWM2, u32ActualReLoadVal2);
