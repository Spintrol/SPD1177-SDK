...
void Slave_TxRX_data(I2C_REGS* I2Cx)
{
    ...
    else
    {
        ...
        /* Read the data had sent to the master just now back and put them into the 'gau8RxBuf' */
...
/*************************************************************************************************************************
 *
 * @brief      In this case, the IIC controller is used as salve opened the 'STOP' INT, and master sent data to slave with
 *             a 'STOP' CMD after every byte, in other words, IIC will stop after every byte, so the number of INT equal the
 *             number of bytes had sent.
 *
 *             This demo code is couple with the master demo code named "I2C_Master_Polling_TxRx".
 *
 *************************************************************************************************************************/
