...
#define               SampleRgisterNVol       1500                               /* Sampler register negative voltage : 1500mV */
...
int main(void)
{
    ...
    */
     ...
     * 2. Set DAC voltage, COMP_HI's negative port is 2000mV, COMP_LO's positive port is 1000mV
     */
