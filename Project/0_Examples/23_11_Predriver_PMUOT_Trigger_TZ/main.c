...
/*************************************************************************************************************************
 *
 * @brief      This case show how to use PMU over-temperature signal to trigger TZ.
 *
 *
 *
 *************************************************************************************************************************/
...
int main(void)
{
    ...
    eErrorState = EPWR_WriteRegisterField(HV_REG_EVTTHCTL0, EVTTHCTL0_PMUOTWARN_Msk, EVTTHCTL0_PMUOTWARN_129C);
    if (eErrorState == ERROR)
    {
    ...
    /* Enable PMU over-temperature interrupt */
    eErrorState = EPWR_WriteRegister(HV_REG_TZIE1, TZIE1_PMUOTWARN_ENABLE);
    if (eErrorState == ERROR)
    {
