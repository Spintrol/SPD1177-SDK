...
/*************************************************************************************************************************
 *
 * @brief      In this case, 40kHz waveform with 75% duty will be output through PWM1 A channel, bringing out by PWM up
...
int main(void)
{
    ...
    */
    PWM_ActionQualifierCHA(PWM1, AQCTLAA_ZRO_SET_HIGH
                           | AQCTLAA_CAU_DO_NOTHING
                           | AQCTLAA_PRD_DO_NOTHING
                           | AQCTLA_CAD_SET_LOW);

    /* Set PWM1A output 75% duty waveform */
