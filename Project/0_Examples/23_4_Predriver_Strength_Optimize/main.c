...
/*************************************************************************************************************************
 *
 * @brief      This case show how to use the strength parameter to generate optimize three phase wave.
 *
 *
 *************************************************************************************************************************/
...
int main(void)
{
    ...
    EPWR_WriteRegister(HV_REG_PDRVLSPDSTR0, 0x1F1F);
    EPWR_WriteRegister(HV_REG_PDRVLSPDSTR1, 0x1F1F);
    EPWR_WriteRegister(HV_REG_PDRVLSPUSTR0, 0x1F1F);
    EPWR_WriteRegister(HV_REG_PDRVLSPUSTR1, 0x1F1F);
    EPWR_WriteRegister(HV_REG_PDRVHSPDSTR0, 0x1F1F);
    EPWR_WriteRegister(HV_REG_PDRVHSPDSTR1, 0x1F1F);
    EPWR_WriteRegister(HV_REG_PDRVHSPUSTR0, 0x1F1F);
    EPWR_WriteRegister(HV_REG_PDRVHSPUSTR1, 0x1F1F);
    EPWR_WriteRegister(HV_REG_PDRVLSPDLEN, 0xFFFF);
    EPWR_WriteRegister(HV_REG_PDRVLSPULEN, 0xFFFF);
    EPWR_WriteRegister(HV_REG_PDRVHSPDLEN, 0xFFFF);
    EPWR_WriteRegister(HV_REG_PDRVHSPULEN, 0xFFFF);
