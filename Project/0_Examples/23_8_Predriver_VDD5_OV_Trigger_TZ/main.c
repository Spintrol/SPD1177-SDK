...
/*************************************************************************************************************************
 *
 * @brief      This case show how to use VDD5 over-voltage signal to trigger TZ.
 *
 *
 *************************************************************************************************************************/
...
int main(void)
{
    ...
    /* Set the VDD5 over-voltage threshold */
    eErrorState = EPWR_WriteRegisterField(HV_REG_EVTTHCTL0, EVTTHCTL0_VDD5OV_Msk, EVTTHCTL0_VDD5OV_5P26V );
    if (eErrorState == ERROR)
    {
    ...
    /* Enable VDD5 under-voltage and VDD5 over-voltage interrupt */
    eErrorState = EPWR_WriteRegister(HV_REG_TZIE0, TZIE0_VDD5OV_ENABLE | TZIE0_VDD5UV_ENABLE);
    if (eErrorState == ERROR)
    {
