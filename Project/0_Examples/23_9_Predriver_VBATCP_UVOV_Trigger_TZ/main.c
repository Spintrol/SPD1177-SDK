...
/*************************************************************************************************************************
 *
 * @brief      This case show how to use VBATCP under-voltage and VBATCP over-voltage signal to trigger TZ.
 *
 *
 *************************************************************************************************************************/
...
int main(void)
{
    ...
    /* Set the VBATCP under-voltage and VBATCP over-voltage threshold */
    ...
    /* Enable VBATCP under-voltage and VBATCP over-voltage interrupt */
    eErrorState = EPWR_WriteRegister(HV_REG_TZIE1, TZIE1_VBATCPOV_ENABLE | TZIE1_VBATCPUV_ENABLE);
    if (eErrorState == ERROR)
    {
...
void EPWRTZ1_IRQHandler()
{
    printf("EPWRTZ1 happened\n");
    EPWR_ClearTripEventFlag(EPWR_TRIP_EVENT_TZ1);
}
