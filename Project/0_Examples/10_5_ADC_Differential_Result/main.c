...
/*************************************************************************************************************************
 *
 * @brief      In this case, we use two PIN_GPIO0 PIN_GPIO1 as the input of the ADC, then getting result from the trim register.
...
int main(void)
{
    ...
    /*ADC Init*/
    ADC_EasyInit2(ADC, ADC_CH0, PIN_GPIO0, PIN_GPIO1, ADC_SOC_TRIGGER_FROM_SOFTWARE);
