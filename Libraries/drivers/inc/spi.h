...
void SPI_MasterTransceive(SPI_REGS *SPIx, uint32_t *pu32WriteBuffer, uint32_t *pu32ReadBuffer, uint32_t u32Size) ;
void SPI_MasterB2BTransceive(SPI_REGS *SPIx, uint32_t *pu32WriteBuffer, uint32_t *pu32ReadBuffer, uint32_t u32Size) ;
void SPI_MasterB2BTransceive(SPI_REGS *SPIx, uint32_t *pu32WriteBuffer, uint32_t *pu32ReadBuffer, uint32_t u32Size) ;

void SPI_SlaveTransceive(SPI_REGS *SPIx, uint32_t *pu32WriteBuffer, uint32_t *pu32ReadBuffer, uint32_t u32Size) ;
