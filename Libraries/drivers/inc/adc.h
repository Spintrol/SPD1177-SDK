...
typedef enum
{
...
#if   (defined(SPC1169) || defined(SPD1179))
    ...
    ADC_SOC_TRIGGER_FROM_PWM1SOCA   = 0x0008,   /*!< SOC[x] from PWM1 SOCA              */
    ADC_SOC_TRIGGER_FROM_PWM1SOCB   = 0x0009,   /*!< SOC[x] from PWM1 SOCB              */
    ADC_SOC_TRIGGER_FROM_PWM2SOCA   = 0x000A,   /*!< SOC[x] from PWM2 SOCA              */
    ADC_SOC_TRIGGER_FROM_PWM2SOCB   = 0x000B,   /*!< SOC[x] from PWM2 SOCB              */
    // Group 1
    ADC_SOC_TRIGGER_FROM_PWM3SOCA   = 0x000C,   /*!< SOC[x] from PWM3 SOCA              */
    ADC_SOC_TRIGGER_FROM_PWM3SOCB   = 0x000D,   /*!< SOC[x] from PWM3 SOCB              */
    ADC_SOC_TRIGGER_FROM_PWM3SOCC   = 0x000E,   /*!< SOC[x] from PWM3 SOCC              */
    ADC_SOC_TRIGGER_FROM_PWM4SOCA   = 0x000F,   /*!< SOC[x] from PWM4 SOCA              */
    ADC_SOC_TRIGGER_FROM_PWM4SOCB   = 0x0010,   /*!< SOC[x] from PWM4 SOCB              */
    ADC_SOC_TRIGGER_FROM_PWM5SOCA   = 0x0011,   /*!< SOC[x] from PWM5 SOCA              */
    ADC_SOC_TRIGGER_FROM_PWM5SOCB   = 0x0012,   /*!< SOC[x] from PWM5 SOCB              */
    // Group 2
    ADC_SOC_TRIGGER_FROM_PWM6SOCA   = 0x0013,   /*!< SOC[x] from PWM6 SOCA              */
    ADC_SOC_TRIGGER_FROM_PWM6SOCB   = 0x0014,   /*!< SOC[x] from PWM6 SOCB              */
    ADC_SOC_TRIGGER_FROM_PWM6SOCC   = 0x0015,   /*!< SOC[x] from PWM6 SOCC              */
    ADC_SOC_TRIGGER_FROM_PWM7SOCA   = 0x0016,   /*!< SOC[x] from PWM7 SOCA              */
    ADC_SOC_TRIGGER_FROM_PWM7SOCB   = 0x0017,   /*!< SOC[x] from PWM7 SOCB              */
    ADC_SOC_TRIGGER_FROM_PWM8SOCA   = 0x0018,   /*!< SOC[x] from PWM8 SOCA              */
    ADC_SOC_TRIGGER_FROM_PWM8SOCB   = 0x0019,   /*!< SOC[x] from PWM8 SOCB              */
    // Group 3
    ADC_SOC_TRIGGER_FROM_PWM9SOCA   = 0x001A,   /*!< SOC[x] from PWM9 SOCA              */
    ADC_SOC_TRIGGER_FROM_PWM9SOCB   = 0x001B,   /*!< SOC[x] from PWM9 SOCB              */
    ADC_SOC_TRIGGER_FROM_PWM10SOCA  = 0x001C,   /*!< SOC[x] from PWM10 SOCA             */
    ADC_SOC_TRIGGER_FROM_PWM10SOCB  = 0x001D,   /*!< SOC[x] from PWM10 SOCB             */
    ADC_SOC_TRIGGER_FROM_PWM11SOCA  = 0x001E,   /*!< SOC[x] from PWM11 SOCA             */
    ADC_SOC_TRIGGER_FROM_PWM11SOCB  = 0x001F,   /*!< SOC[x] from PWM11 SOCB             */
#endif
