...
#define LIN_N_AS_AND_N_CR_TIMEOUT      1000 /* ms */

/* Calculate N_As & N_Cr max timeout */
#define N_MAX_TIMEOUT_CNT ((l_u16)(LIN_N_AS_AND_N_CR_TIMEOUT/100))
...
#define RECV_TIMEOUT        0x0B          /**< receive timeout state */
#define RECV_FRMERR         0x0C          /**< receive frame error state */
#define SEND_BITERR         0x0D          /**< Received bit is different to the transmitted bit */
